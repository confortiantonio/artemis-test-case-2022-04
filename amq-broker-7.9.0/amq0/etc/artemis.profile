...
ARTEMIS_HOME='/sviluppo/amq-broker/amq-broker-7.9.0'
ARTEMIS_INSTANCE='/sviluppo/amq-broker/amq-broker-7.9.0/instances/amq0'
ARTEMIS_DATA_DIR='/sviluppo/amq-broker/amq-broker-7.9.0/instances/amq0/data'
ARTEMIS_OOME_DUMP='/sviluppo/amq-broker/amq-broker-7.9.0/instances/amq0/log/oom_dump.hprof'

# The logging config will need an URI
# this will be encoded in case you use spaces or special characters
# on your directory structure
ARTEMIS_INSTANCE_URI='file:/sviluppo/amq-broker/amq-broker-7.9.0/instances/amq0/'
ARTEMIS_INSTANCE_ETC_URI='file:/sviluppo/amq-broker/amq-broker-7.9.0/instances/amq0/etc/'
...
# Java Opts
if [ -z "$JAVA_ARGS" ]; then
    JAVA_ARGS="-XX:+PrintClassHistogram -XX:+UseG1GC -Xms512M -Xmx2G -Dhawtio.disableProxy=true -Dhawtio.realm=activemq -Dhawtio.offline=true -Dhawtio.rolePrincipalClasses=org.apache.activemq.artemis.spi.core.security.jaas.RolePrincipal -Djolokia.policyLocation=${ARTEMIS_INSTANCE_ETC_URI}jolokia-access.xml -Djon.id=amq "
fi
#
